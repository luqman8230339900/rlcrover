...
from rtcbot import RTCConnection, getRTCBotJS, CVCamera ,CVCamera1
...
class ConnectionHandler:
    ...
    def __init__(self):
        ...
        self.videoSubscription1 = camera1.subscribe()
        self.conn.video.putSubscription1(self.videoSubscription1)
